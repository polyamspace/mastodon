...
RSpec.describe Form::Import do
  ...
  describe 'save' do
    ...
    # Polyam: Added `reject.reports` to fix imports of such
    it_behaves_like('on successful import', 'domain_blocking', 'merge', 'domain_blocks.csv', %w(bad.domain worse.domain reject.media reject.reports).map { |domain| { 'domain' => domain } })
