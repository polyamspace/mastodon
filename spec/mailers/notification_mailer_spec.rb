...
RSpec.describe NotificationMailer, type: :mailer do
  ...
  describe 'favourite' do
    ...
    it 'renders the headers' do
      expect(mail.subject).to eq('bob favourited your toot')
      expect(mail[:to].value).to eq("#{receiver.account.username} <#{receiver.email}>")
    end

    it 'renders the body' do
      expect(mail.body.encoded).to match('Your toot was favourited by bob')
  ...
  describe 'reblog' do
    ...
    it 'renders the headers' do
      expect(mail.subject).to eq('bob boosted your toot')
      expect(mail[:to].value).to eq("#{receiver.account.username} <#{receiver.email}>")
    end
