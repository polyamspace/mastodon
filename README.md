...
- Toots written in HTML or Markdown will display the raw source instead, unless the fork supports them.
- Local-only toots will federate, meaning remote users can see and interact with them, unless the fork supports them.
