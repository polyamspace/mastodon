...
const SignInBanner = () => {
  ...
  return (
    <div className='sign-in-banner'>
      <p><FormattedMessage id='sign_in_banner.text' defaultMessage='Login to follow profiles or hashtags, favourite, share and reply to toots. You can also interact from your account on a different server.' /></p>
      {signupButton}
