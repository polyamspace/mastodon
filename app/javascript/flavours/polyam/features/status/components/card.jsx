...
export default class Card extends PureComponent {
  ...
  render () {
            ...
            {revealed ? (
              <div className='status-card__actions' onClick={this.handleEmbedClick} role='none'>
                <div>
                  ...
                  <a href={card.get('url')} onClick={this.handleExternalLinkClick} target='_blank' rel='noopener'><Icon id='external-link' icon={ExternalLinkIcon} /></a>
                </div>
              </div>
            ) : spoilerButton}
          </div>
    ...
    return (
      <>
        <a href={card.get('url')} className={classNames('status-card', { expanded: !compact && largeImage, bottomless: showAuthor })} target='_blank' rel='noopener' ref={this.setRef}>
          {embed}
          {description}
        </a>
