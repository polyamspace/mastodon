...
import { emojiUse } from '@/flavours/polyam/actions/emojis';
import { changeSetting } from '@/flavours/polyam/actions/settings';
import { IconButton } from '@/flavours/polyam/components/button/redesign';
import { CircularProgress } from '@/flavours/polyam/components/circular_progress';
import { Dropdown } from '@/flavours/polyam/components/dropdown/redesign';
import type { PopoverChildProps } from '@/flavours/polyam/components/popover';
...
const EmojiPicker = lazy(() =>
  import('@/flavours/polyam/features/emoji/emoji_picker').then(
    ({ Picker }) => ({
      default: Picker,
    }),
  ),
...
const Emoji = lazy(() =>
  import('@/flavours/polyam/features/emoji/emoji_picker').then(({ Emoji }) => ({
    default: Emoji,
  })),
);
