        ...
        <ul>
          ...
          {options.size < pollLimits.max_options && (
            <label className='poll__text editable'>
              ...
              <button className='button button-secondary' onClick={this.handleAddOption} type='button'><Icon id='plus' icon={faPlus} /> <FormattedMessage {...messages.add_option} /></button>
            </label>
          )}
        </ul>
