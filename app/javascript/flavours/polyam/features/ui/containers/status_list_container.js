...
const makeGetStatusIds = (pending = false) => createSelector([
  ...
  return statusIds.filter(id => {
    ...
    if (columnSettings.getIn(['shows', 'thread']) === false && statusForId.get('in_reply_to_account_id') === statusForId.get('account')) {
      return false;
    }
...
const makeMapStateToProps = () => {
  ...
  const mapStateToProps = (state, { firehose = false, columnId = undefined, timelineId, regex, initialLoadingState = true }) => ({
