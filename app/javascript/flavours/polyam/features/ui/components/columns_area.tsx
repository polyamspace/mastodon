...
import { ColumnIndexContext } from '@/flavours/polyam/components/column/context';
import { useAppSelector } from '@/flavours/polyam/store';
import { isRedesignEnabled } from '@/flavours/polyam/utils/environment';
import { Footer } from 'flavours/polyam/features/custom_homepage/components/footer';
import { Header } from 'flavours/polyam/features/custom_homepage/components/header';
import { CollapsibleNavigationPanel } from 'flavours/polyam/features/navigation_panel';
...
const LazyRedesignNavigationPanel = lazy(() =>
  import('@/flavours/polyam/features/navigation_panel/redesign').then(
