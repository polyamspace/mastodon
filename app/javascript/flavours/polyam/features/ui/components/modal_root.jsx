...
export const MODAL_COMPONENTS = {
  ...
  'ACCOUNT_JOIN_DATE': () => import('@/flavours/polyam/features/account_timeline/modals/join_modal').then(module => ({ default: module.AccountJoinModal })),
...
function accountEditModal(type) {
  return () => import('@/flavours/polyam/features/account_edit/modals').then(module => ({ default: module[type] }));
}
