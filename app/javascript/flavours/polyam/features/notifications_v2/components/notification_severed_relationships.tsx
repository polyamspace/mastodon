import { RelationshipsSeveranceEvent } from 'flavours/polyam/features/notifications/components/relationships_severance_event';
import type { NotificationGroupSeveredRelationships } from 'flavours/polyam/models/notification_group';
