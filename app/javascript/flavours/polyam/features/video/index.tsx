...
import RectangleIcon from '@/awesome-icons/solid/up-right-and-down-left-from-center.svg?react';
...
export const Video: React.FC<{
  ...
  const handleOpenAltText = useCallback(() => {
    if (!videoRef.current) {
      return;
    }
        ...
        >
          ...
          <div className='video-player__buttons-bar'>
            ...
            <div className='video-player__buttons right'>
              {!fullscreen && alt && onOpenAltText && (
                <button
                  type='button'
                  title={intl.formatMessage(messages.alt)}
                  aria-label={intl.formatMessage(messages.alt)}
                  className='player-button'
                  onClick={handleOpenAltText}
                >
                  <span>ALT</span>
                </button>
              )}
              ...
              {onCloseVideo && (
                ...
                >
                  <Icon id='compress' icon={CompressIcon} />
                </button>
              )}
              <button
                type='button'
