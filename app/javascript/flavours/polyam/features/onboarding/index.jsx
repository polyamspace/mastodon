...
import { faCopy, faPencilSquare, faUserPlus, faArrowRight } from '@fortawesome/free-solid-svg-icons';
        ...
        <Route path='/start' exact>
          <div className='scrollable privacy-policy'>
            ...
            <div className='onboarding__steps'>
              ...
              <Step to='/start/follows' completed={(account.get('following_count') * 1) >= 1} icon='user-plus' iconComponent={faUserPlus} label={<FormattedMessage id='onboarding.steps.follow_people.title' defaultMessage='Find at least {count, plural, one {one person} other {# people}} to follow' values={{ count: 7 }} />} description={<FormattedMessage id='onboarding.steps.follow_people.body' defaultMessage="You curate your own home feed. Let's fill it with interesting people." />} />
              <Step onClick={handleComposeClick} completed={(account.get('statuses_count') * 1) >= 1} icon='pencil-square-o' iconComponent={faPencilSquare} label={<FormattedMessage id='onboarding.steps.publish_status.title' defaultMessage='Make your first post' />} description={<FormattedMessage id='onboarding.steps.publish_status.body' defaultMessage='Say hello to the world.' values={{ emoji: <img className='emojione' alt='🐘' src={`${assetHost}/emoji/1f418.svg`} /> }} />} />
              <Step to='/start/share' icon='copy' iconComponent={faCopy} label={<FormattedMessage id='onboarding.steps.share_profile.title' defaultMessage='Share your profile' />} description={<FormattedMessage id='onboarding.steps.share_profile.body' defaultMessage='Let your friends know how to find you on Mastodon!' />} />
            </div>
            ...
            <div className='onboarding__links'>
              <Link to='/explore' className='onboarding__link'>
                ...
                <Icon id='arrow-right' icon={faArrowRight} />
              </Link>
