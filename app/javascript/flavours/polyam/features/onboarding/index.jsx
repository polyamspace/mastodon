...
import { faCopy, faPencilSquare, faUserPlus } from '@fortawesome/free-solid-svg-icons';
      ...
      <Column>
        <div className='scrollable privacy-policy'>
          ...
          <div className='onboarding__steps'>
            ...
            <Step onClick={this.handleFollowClick} completed={(account.get('following_count') * 1) >= 7} icon='user-plus' iconComponent={faUserPlus} label={<FormattedMessage id='onboarding.steps.follow_people.title' defaultMessage='Find at least {count, plural, one {one person} other {# people}} to follow' values={{ count: 7 }} />} description={<FormattedMessage id='onboarding.steps.follow_people.body' defaultMessage="You curate your own home feed. Let's fill it with interesting people." />} />
