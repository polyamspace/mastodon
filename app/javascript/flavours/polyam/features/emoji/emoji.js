...
const emojifyTextNode = (node, customEmojis) => {
  ...
  for (;;) {
    ...
    if (str[i] === ':') { // Potentially the start of a custom emoji :shortcode:
      ...
      const isSystemTheme = !!document.body?.classList.contains('skin-system');

      const theme = (isSystemTheme || document.body?.classList.contains('skin-mastodon-light')) ? 'light' : 'dark';
