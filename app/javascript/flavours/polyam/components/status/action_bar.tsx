...
import {
  ...
  unblockDomain,
} from '@/flavours/polyam/actions/domain_blocks';
import type { StatusInteractionIntent } from '@/flavours/polyam/actions/interactions';
import { statusInteraction } from '@/flavours/polyam/actions/interactions';
...
import type { StatusShape } from '@/flavours/polyam/models/status';
import {
    ...
    <div className='status__action-bar'>
      ...
      <div className='status__action-bar__button-wrapper'>
        <IconButton
          ...
          icon='star'
          // Polyam: No variants as checkmark via CSS
