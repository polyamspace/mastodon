...
const MediaGallery = lazy<TMediaGallery>(
  () => import('@/flavours/polyam/components/media_gallery'),
);
const Audio = lazy(() => import('@/flavours/polyam/features/audio'));
const Video = lazy(() => import('@/flavours/polyam/features/video'));
    ...
    return (
      ...
      >
        <Audio
          ...
          onOpenAltText={handleOpenAltText}
        />
      </Suspense>
    );
  }
